...
class RouteInput extends Component {
    ...
    render() {
        const { inputA, inputB, toggleLayer, route, resetRoute } = this.props;
        ...
        return (
            <div className="routeInput">
                ...
                <div className="row routeInput__sectionB">
                    ...
                    <div id="inputB">{inputB}</div>
                </div>
                <div className="row routeInput__generateSection">
                    <div className={classNames({ "generateButton": true, "generateButton--disabled": inputA == undefined || inputB  == undefined })}>
                        <span>Generate Route</span>
                    </div>
                    {route &&
                        <div className="resetButton" onClick={() => { resetRoute() }}>
                            <span>❌</span>
                        </div>
                    }
                </div>
                <div className="row">
                    <span><b>Toggles</b></span>
                </div>
                <div className="row routeInput__toggleButtons">
                    ...
                    <div id="toggleCrimeMarkers" className={classNames({ "emojiButton": true, "emojiButton--inactive": !crimeButton })} onClick={() => { this.toggleButton('domObjects', 'marker--crime', 'crimeButton') }}>👿</div>
                    <div id="toggleCameraMarkers" className={classNames({ "emojiButton": true, "emojiButton--inactive": !camerasButton })} onClick={() => { this.toggleButton('domObjects', 'marker--camera', 'camerasButton') }}>📹</div>
                    <div id="toggleBoundry" className={classNames({ "emojiButton": true, "emojiButton--inactive": boundryButton })} onClick={() => { this.toggleButton('layer', 'boundry-layer', 'boundryButton') }}>🚧</div>
